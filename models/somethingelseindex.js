...
const monogoose=require("./somethingelseindex");
module.exports = {
  //select all users
  getAllUsers: (req, res) => {
    db
  ...
  getUserActivities: (req, res) => {
    db
      ...
      .findAll({
        ...
        include: [db.patrons,db.registration,db.reservations,db.property]
      })
      .then(dbUsers => {
        res.json(dbUsers);
  ...
  //add a user where we will make use of all passport
