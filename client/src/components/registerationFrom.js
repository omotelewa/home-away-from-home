...
class Inquiry extends Component {
  ...
  render () {
    ...
    return (
      <Grid container propertyName={property.container}>
        <Grid item xs={12}>
        ...
        <Grid item xs={12} sm={6}>
          <TextField
            ...
            id="first-name"
            label="First Name"
            propertyName={property.textField}
        ...
        <Grid item xs={12} sm={6}>
          {' '}
          <FormControl propertyName={properties.formControl}>
